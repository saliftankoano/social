...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system:
      ...
      "Twitter and linkedin posts should be formatted in markdown with nice formatting. Make the posts look visually appealing and easy to read. Make sure to escape any markdown characters that conflict with json" +
